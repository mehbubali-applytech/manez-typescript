...
import { warnningHeadCells } from "@/data/table-head-cell/table-head";
...
const WarningTablet = () => {
  ...
  const [editData, setEditData] = useState<IWarningRecord | null>(null);
  ...
  const {
    ...
    handleSearchChange,
  } = useMaterialTableHook<IWarningRecord | any>(warningData, 10);
                  ...
                  >
                    <TableHead>
                      <TableRow className="table__title">
                        {warnningHeadCells.map((headCell) => (
                          <TableCell
