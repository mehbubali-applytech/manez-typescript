// components/finance/dashboard/CostAnalysisChart.tsx
"use client";
import React, { useState } from 'react';
import { Tab, Tabs } from '@mui/material';
import FinanceCostChart from './FinanceCostChart';
        ...
        <div className="col-span-12 lg:col-span-8">
            <div className="card__wrapper card-tab-wrapper">
                <div className="card__title-wrap flex flex-wrap gap-[10px] items-center justify-between mb-[25px]">
                    <h5 className="card__heading-title">Cost Analysis</h5>
                                ...
                                <div hidden={value !== 0}>
                                    {value === 0 && (
                                        <div className="card__line-chart">
                                            <FinanceCostChart period="monthly" />
                                        </div>
                                    )}
                                </div>
                                <div hidden={value !== 1}>
                                    {value === 1 && (
                                        <div className="card__line-chart">
                                            <FinanceCostChart period="quarterly" />
                                        </div>
                                    )}
                                </div>
                                <div hidden={value !== 2}>
                                    {value === 2 && (
                                        <div className="card__line-chart">
                                            <FinanceCostChart period="yearly" />
                                        </div>
                                    )}
                                </div>
                            </>
