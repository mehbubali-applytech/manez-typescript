...
interface CompanyFinanceExecutiveFiltersProps {
...
const CompanyFinanceExecutiveFilters: React.FC<CompanyFinanceExecutiveFiltersProps> = ({
  selectedStatus,
  setSelectedStatus,
  selectedDepartment,
...
export default CompanyFinanceExecutiveFilters;