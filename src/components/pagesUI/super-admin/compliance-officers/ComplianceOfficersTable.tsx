...
const headCells = [
  { id: "compName", label: "Compliance Officer Name" },
  { id: "compCode", label: "Compliance Code" },
  { id: "company", label: "Company" },
  { id: "department", label: "Department" },
];

interface Props {
  data: IComplianceOfficer[];
}

const ComplianceOfficersTable: React.FC<Props> = ({ data }) => {
                  ...
                  <TableBody>
                    {paginatedRows.map((row, index) => (
                      ...
                      >
                        ...
                        <TableCell>{row.compCode}</TableCell>
                          ...
                          <div className="flex gap-[10px]">
                            ...
                            <button
                              ...
                              onClick={(e) => {
                                e.stopPropagation();
                                router.push(
                                  `/super-admin/compliance-officers/${row.compCode}`
                                );
                              }}
                            >
