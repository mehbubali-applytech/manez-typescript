...
import { subscriptionStatePropsType } from "@/interface/common.interface";
import { ISubscription, ISubscriptionForm} from "../subscription.interface"
...
const EditSubscriptionModal = ({ 
  ...
  const [tags, setTags] = useState<string[]>(editData?.modules || ["CRM", "HR"]);
  ...
  const onSubmit = async (data: ISubscriptionForm) => {
    try {
      ...
      toast.error(
        error?.message || "An error occurred while updating the subscription. Please try again!"
      );
    }
  };
            ...
            <div className="grid grid-cols-12 gap-y-6 gap-x-6 maxXs:gap-x-0 justify-center items-center">
              <div className="col-span-12 md:col-span-6">
                <InputField
                  ...
                  id="subscriptionName"
                  type="text"
                  defaultValue={editData.subscriptionName}
                  required={false}
              ...
              <div className="col-span-12 md:col-span-6">
                <FormLabel label="End Date" id="endDate" optional />
                <div className="datepicker-style">
                  <DatePicker
                    id="endDate"
