                ...
                <div className="company__wrapper">
                    <div className="company__info">
                        ...
                        <div className="company__name mb-5">
                            <h3 className="company__title">{companyData?.name}</h3>
                        </div>
                        ...
                        <div className="company__info-list style-two">
                            ...
                            <ul>
                                <li>
                                    <span>Language:</span> {companyData?.language || "—"}
                                </li>
                                <li>
                                    <span>Currency:</span> {companyData?.currencyType || "—"}
                                </li>
                                <li>
                                    <span>Source:</span> {companyData?.source || "—"}
                                </li>
                                <li>
                        ...
                        <div className="company__info-list style-three">
                            ...
                            <ul>
                                <li>
                                    <span>Name:</span>{companyData?.owner || "—"}
                                </li>
                                <li>
                                    <span>Number:</span>{" "}
