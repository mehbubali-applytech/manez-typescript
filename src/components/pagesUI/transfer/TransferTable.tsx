...
import { transferHeadCells } from "@/data/table-head-cell/table-head";
...
const TransferTable = () => {
  ...
  const [editData, setEditData] = useState<ITransfer | null>(null);
  ...
  const {
    ...
    handleSearchChange,
  } = useMaterialTableHook<ITransfer | any>(transferData, 10);
                  ...
                  >
                    <TableHead>
                      <TableRow className="table__title">
                        {transferHeadCells.map((headCell) => (
                          <TableCell
                    ...
                    <TableBody className="table__body">
                      {paginatedRows.map((row, index) => (
                        ...
                        >
                          <TableCell>{row?.prevBranch}</TableCell>
                          <TableCell>{row?.newBranch}</TableCell>
