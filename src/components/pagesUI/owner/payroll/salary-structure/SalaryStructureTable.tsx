      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="space-y-4 mb-6">
          {formFields.map((field, index) => (
            <div
              key={field.id}
              className={`grid grid-cols-1 sm:grid-cols-12 gap-4 items-center p-4 rounded-lg transition-all duration-200 ${
                isEditing ? "bg-blue-50 border border-blue-100 hover:bg-blue-100" : "hover:bg-gray-50"
              }`}
            >
              {/* Component Name */}
