              ...
              <div className="grid grid-cols-12 gap-5 maxXs:gap-x-0">
                <div className="col-span-12 md:col-span-7">
                  <div className="invoice__logo mb-5">
                    {/* <Image className="light-logo" src={sidebarMainLogo}  priority alt="payslip logo"/> */}
                    <Image className="light-logo" src="../../../../../public/assets/images/logo/logo.svg" priority alt="payslip logo" width={50} height={50}/>
                  </div>
